...
public class CustomFont {
     ...
     * @return
     */
    public static String convertOneLineText(String text) {
     ...
     * @throws IOException
     */
    public static String convertOneLineImage(String urlImage) throws IOException {
        URL url = new URL(urlImage);
        BufferedImage image = ImageIO.read(url);
        if (image == null)
            throw new IllegalArgumentException(image + " is not a valid image.");
        ...
        for (int y = 0; y < image.getHeight(); y++) {
            ...
            for (int x = 0; x < image.getWidth(); x++) {
                ...
                double gValue = (double) pixelColor.getRed() * RED + (double) pixelColor
                        .getBlue() * BLUE + (double) pixelColor.getGreen() * GREEN;
     ...
     * @return char
     */
    private static char lightCharacter(double pixel) {
        final char str;
     ...
     * @return char
     */
    private static char darkCharacter(double pixel) {
        final char str;
